    ...
    case EJDB_IDX_STR:
      switch (jbvt) {
        ...
        case JBV_BOOL:
          ...
          break;
        case JBV_F64:
          jb_idx_ftoa(node->vf64, numbuf, &ikey->size);
          ikey->data = numbuf;
          break;
        default:
          break;
    ...
    case EJDB_IDX_F64:
      ...
      switch (jbvt) {
        case JBV_F64:
          ...
          break;
        case JBV_I64:
          jb_idx_ftoa(node->vi64, numbuf, &ikey->size);
          break;
        case JBV_BOOL:
          jb_idx_ftoa(node->vbool, numbuf, &ikey->size);
          break;
        case JBV_STR:
          jb_idx_ftoa(iwatof(node->vptr), numbuf, &ikey->size);
          break;
        default:
          ikey->size = 0;
          ikey->data = 0;
