...
public final class IWKVOptions implements Serializable {
    ...
    public String toString() {
        return new StringJoiner(", ", IWKVOptions.class.getSimpleName() + "[", "]")
                .add("path='" + path + "'")
                .add("oflags=" + oflags)
                .add("file_lock_fail_fast=" + file_lock_fail_fast)
    ...
    public static final class WALOptions implements Serializable {
        ...
        public String toString() {
            return new StringJoiner(", ", WALOptions.class.getSimpleName() + "[", "]")
                    ...
                    .add("buffer_sz=" + buffer_sz)
                    .add("checkpoint_buffer_sz=" + checkpoint_buffer_sz)
                    .toString();
        }
    }
}
